...
export class ProductVariantService {
	...
	private productVariants: ProductVariant[] = [
		...
		new ProductVariant(22, 3, 'Dorado con arena dorada', 50, new Date()),
		new ProductVariant(23, 3, 'Dorado con arena blanca', 50, new Date()),
		new ProductVariant(24, 4, 'Alas Plateadas', 50, new Date()),
		new ProductVariant(25, 5, 'Plateado', 50, new Date()),
		new ProductVariant(26, 5, 'Dorado', 50, new Date()),
